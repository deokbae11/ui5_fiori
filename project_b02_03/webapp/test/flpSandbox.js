		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testprojectb0203-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprojectb0203-display": {
								"semanticObject": "testprojectb0203",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.projectb0203",
									"url": sap.ui.require.toUrl("test/projectb0203")
								}
							}
						}
					}
