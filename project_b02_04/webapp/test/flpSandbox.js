		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON CRUD",
									"targetURL": "#projectb0204-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0204-display": {
								"semanticObject": "projectb0204",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0204",
									"url": sap.ui.require.toUrl("projectb0204")
								}
							}
						}
					}
