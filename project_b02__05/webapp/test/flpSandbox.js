		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App title",
									"targetURL": "#projectb0205-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0205-display": {
								"semanticObject": "projectb0205",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0205",
									"url": sap.ui.require.toUrl("projectb0205")
								}
							}
						}
					}
